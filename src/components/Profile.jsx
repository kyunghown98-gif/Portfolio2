         ...
         <div className="profile-grid-dense">
            ...
            <div>
               <p className="profile-p">
                  틀에 얽매이지 않는 창의적인 프론트엔드 개발자 박경훈입니다. 저는 <span>기능과 예술의 경계</span>를 허물며, 시각적으로 강렬하면서도 탄탄한 아키텍처를 기반으로 한 웹 경험을 구축합니다. <span>React, GSAP</span>에 대한 깊은 이해도와 집요한 픽셀 디테일을 바탕으로 사용자에게 잊지 못할 몰입형 디지털 인터랙션을 선사합니다.
               </p>
